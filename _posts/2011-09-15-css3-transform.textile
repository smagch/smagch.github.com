...
_NOTE_: The demo only support certain computers which has GPU acceleration with webkit browser, safari and chrome.
The demo is "here":{{ site.url }}/demo/css3-transform-centering-demo.html
